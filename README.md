...
- Connect preflight with an explicit anonymous/authenticated choice, a bound
  LDAP/StartTLS/LDAPS endpoint, and required credential bind validation;
  passwords stay in memory, while rejected binds produce a redacted trace and
  ordered remediation guidance
